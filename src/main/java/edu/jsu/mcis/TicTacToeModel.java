...
public class TicTacToeModel {
    ...
    public TicTacToeModel(int width) {
        ...
        // board new Mark[4][4];
//        board[0][0] = Mark.EMPTY;
//        board[0][1] = Mark.EMPTY;
//        board[0][2], board[0][3]
//        board[1][0] ~ board[1][4]
//        
...
//        if (row and col are in the bounds of the board) {
//            return true;
//        } else {
//            return false;
//        }
...
//        return board[row][col] == Mark.O || board[row][col] == Mark.X;
    }
    ...
    public Result getResult() {
        ...
        if(isMarkWin(Mark.X)) { // isMarkWin compares the current mark to each mark it is passed from this function
            return Result.X;
